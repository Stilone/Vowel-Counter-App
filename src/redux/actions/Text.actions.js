...
//выполняет цикл map для каждого responses, в котором проверяет регуляркой сколько глассных, и методами split и filter считает количество слов результаты добавляет
